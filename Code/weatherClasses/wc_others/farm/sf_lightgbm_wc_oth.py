...
file_path = \
    'D:/TalTechUniversity/solarIradiance/forecasting/' \
    'nZEB_mektory/solar_farm/data_prepration/farm/datasets/sf_wc_others.csv'
...
params = {
    ...
    # 'num_iterations': 159,
    # 'num_leaves': 53,
    # 'reg_alpha': 15.790686309268454,
    # 'reg_lambda': 180.46555286735145,

    'learning_rate': 0.04203972876145559,
    'max_depth': 18,
    ...
    # mse score: 0.010425397411911097
    # mae score: 0.07022874259297791
    # r2 score: 0.750703603803967
}
