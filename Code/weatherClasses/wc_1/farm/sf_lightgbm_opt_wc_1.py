...
file_path = \
    'D:/TalTechUniversity/solarIradiance/forecasting/nZEB_mektory/solar_farm/data_prepration/farm/datasets/sf_wc_1.csv'
...
def objective(
    ...
    mse_scores_opt = []
    kf_opt = KFold(n_splits=20, shuffle=True, random_state=42)
